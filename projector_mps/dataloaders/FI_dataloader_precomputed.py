...
class FIDataset_precompute():
    def __init__(self, vision_encoder, phase: str = 'train'):
        # phase must be 'train', 'val' or 'test'
        print(f'FI phase: {phase}')
        if vision_encoder == 'openai/clip-vit-large-patch14':
            dataset_root_path = '/home/cgutierrez/shared/features_clip-vit-large-patch14/FI/'
        elif vision_encoder == 'openai/clip-vit-large-patch14-336':
            dataset_root_path = '/home/cgutierrez/shared/features_clip-vit-large-patch14-336/FI/'
        elif vision_encoder == 'openai/clip-vit-base-patch16':
            dataset_root_path = '/home/cgutierrez/shared/features_clip-vit-base-patch16/FI/'
        elif vision_encoder == 'facebook/dinov2-large':
            dataset_root_path = '/home/cgutierrez/shared/features_dinov2-large/FI/'
        elif vision_encoder == 'google/siglip-so400m-patch14-384':
            dataset_root_path = '/home/cgutierrez/shared/features_siglip-so400m-patch14-384/FI/'
        self.phase = phase
