...
if __name__ == '__main__':
    ...
    parser.add_argument('--precomputed', type=bool, help='Use precomputed dataloaders.', default=False)
    ...
    if dataset == 'WEBEmo':
        ...
        train_dataset_25 = WEBEmoDataset_precompute(args.vision_encoder_path, phase='train')
        train_dataset_8 = EmosetDataset_precompute(args.vision_encoder_path, phase='train')
        # train_dataset_6 = EmoROIDataset_precompute(args.vision_encoder_path, phase='train')
        train_dataset = ConcatDataset([train_dataset_8, train_dataset_25])
        validation_dataset = EmosetDataset_precompute(args.vision_encoder_path, phase='test')
        test_dataset = UnbiasedEmoDataset_precompute(args.vision_encoder_path, phase='test')
    else:
